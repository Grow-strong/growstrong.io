<template>
  <div id="home">
    ...
    <section class="section" id="aim">
      ...
      <h2 class="subtitle">
        Grow <strong>Strong!</strong>
      </h2>
      <b-image
        src="https://images.unsplash.com/photo-1458014854819-1a40aa70211c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
      ...
      <div class="content">
        <p>
          ...
          Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam
          accumsan lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla. Vestibulum ante ipsum primis in faucibus
          orci luctus et ultrices posuere cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis et arcu.
          Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris.
          Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus ullamcorper
          ipsum rutrum nunc. Nunc nonummy metus. Vestibulum volutpat pretium libero. Cras id dui. Aenean ut eros et nisl
          sagittis vestibulum. Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet feugiat, pede. Sed lectus.
          ...
          non, euismod vitae, posuere imperdiet, leo. Maecenas malesuada. Praesent congue erat at massa. Sed cursus turpis
          vitae tortor. Donec posuere vulputate arcu. Phasellus accumsan cursus velit. Vestibulum ante ipsum primis in faucibus
    ...
    <section class="section" id="road-map">
      <h1 class="title">Road up</h1>
      <h2 class="subtitle">
        Join our sessions every <strong>Monday</strong>, at 9:00 PM CT.
      </h2>

      <b-image
        src="https://images.unsplash.com/photo-1518281420975-50db6e5d0a97?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80"
        placeholder="/static/img/icons/favicon-32x32.png"
        ratio="2by1"
      ></b-image>
      <br>
    ...
    <section class="section" id="inputs">
      ...
      <h2 class="subtitle">
        Your inputs compounded = results
      </h2>
      <b-image
        src="https://images.unsplash.com/photo-1489533119213-66a5cd877091?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80"
        placeholder="/static/img/icons/favicon-32x32.png"
        ratio="2by1"
      ></b-image>
      <br>
      <div class="content">
        <p>
          ...
          pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus.
          ...
          nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut,
          ...
          lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum.
          ...
          lectus. Donec mollis hendrerit risus. Phasellus nec sem in justo pellentesque facilisis. Etiam imperdiet imperdiet orci.
          Nunc nec neque. Phasellus leo dolor, tempus non, auctor et, hendrerit quis, nisi. Curabitur ligula sapien, tincidunt
        </p>
      </div>
    </section>
    ...
    <section class="section" id="testimonials">
      ...
      <h2 class="subtitle">
        How has Grow Strong benefited people.
      </h2>
...
export default {
  ...
  head() {
    return {
      title: 'Welcome to Grow Strong! :strong:',
      meta: [
        {
          hid: 'grow strong home',
          name: 'home',
          content: 'Unlock your capabilities!'
        }
      ]
    }
  }
